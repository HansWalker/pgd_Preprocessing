...
output_dir = 'outputs'
trained_model_path = 'trained_models/sargan_cifar10x2-32'
trained_model_path2 = 'trained_models/sargan_cifar10-32'
        ...
        with tf.Session() as sess2:
            ...
            for i in range(NUM_ITERATION):
                ...
                for k in range(len(features)):
                    features[k]=gaussian_filter(add_gaussian_noise(features[k], sd=np.random.uniform(NOISE_STD_RANGE[1], NOISE_STD_RANGE[1])), sigma=.5)
