...
output_dir = 'outputs'
trained_model_path = 'trained_models/sargan_cifar10x2'
trained_model_path2 = 'trained_models/sargan_cifar10'
        ...
        with tf.Session() as sess2:
            ...
            for i in range(NUM_ITERATION):
                ...
                for i in range(len(features)):
                    features[i]=gaussian_filter(add_gaussian_noise(features[i], sd=np.random.uniform(NOISE_STD_RANGE[1], NOISE_STD_RANGE[1])), sigma=2)
