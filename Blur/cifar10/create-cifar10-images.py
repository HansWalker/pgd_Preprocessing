...
def evaluate_checkpoint(filename):
    ...
    # Restore the checkpoint
        ...
        for ibatch in range(num_batches):
            ...
            nextimage.save("CIFAR10_NATURALX0.Jpg","JPEG")
            ...
            nextimage=Image.fromarray(x_batch3.astype(np.uint8))
            nextimage.save("CIFAR10_BLURX0.Jpg","JPEG")
            x_batch3=np.zeros([img_size[0],img_size[1]])
            x_batch3[:,:]=x_adv_list4[0][0,:,:,0]*255
            nextimage=Image.fromarray(x_batch3.astype(np.uint8))
            nextimage.save("CIFAR10_ADVX0.Jpg","JPEG")
    ...
    with gx1.as_default():
        with tf.Session() as sess2:
            ...
            x_batch3[:,:]=x_blur_list4[0][0,:,:,0]*255
            nextimage=Image.fromarray(x_batch3.astype(np.uint8))
            nextimage.save("CIFAR10_BLURX1.Jpg","JPEG")
            x_batch3=np.zeros([img_size[0],img_size[1]])
            x_batch3[:,:]=x_adv_list4[0][0,:,:,0]*255
            nextimage=Image.fromarray(x_batch3.astype(np.uint8))
            nextimage.save("CIFAR10_ADVX1.Jpg","JPEG")
    ...
    with gx2.as_default():
        with tf.Session() as sessx2:
            ...
            x_batch3[:,:]=x_blur_list4[0][0,:,:,0]*255
            nextimage=Image.fromarray(x_batch3.astype(np.uint8))
            nextimage.save("CIFAR10_BLURX2.Jpg","JPEG")
            x_batch3=np.zeros([img_size[0],img_size[1]])
            x_batch3[:,:]=x_adv_list4[0][0,:,:,0]*255
            nextimage=Image.fromarray(x_batch3.astype(np.uint8))
            nextimage.save("CIFAR10_ADVX2.Jpg","JPEG")
    ...
    with gx3.as_default():
        with tf.Session() as sessx3:
            ...
            x_batch3[:,:]=x_blur_list4[0][0,:,:,0]*255
            nextimage=Image.fromarray(x_batch3.astype(np.uint8))
            nextimage.save("CIFAR10_BLURX3.Jpg","JPEG")
            x_batch3=np.zeros([img_size[0],img_size[1]])
            x_batch3[:,:]=x_adv_list4[0][0,:,:,0]*255
            nextimage=Image.fromarray(x_batch3.astype(np.uint8))
            nextimage.save("CIFAR10_ADVX3.Jpg","JPEG")
    ...
    with gx4.as_default():
        with tf.Session() as sessx4:
            ...
            for ibatch in range(num_batches):
                ...
                nextimage=Image.fromarray(x_batch3.astype(np.uint8))
                nextimage.save("CIFAR10_ADVX4.Jpg","JPEG")
                ...
                nextimage=Image.fromarray(x_batch3.astype(np.uint8))
                nextimage.save("CIFAR10_BLURX4.Jpg","JPEG")
