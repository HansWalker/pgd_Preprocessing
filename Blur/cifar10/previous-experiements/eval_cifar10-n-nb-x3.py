...
trained_model_path2 = 'trained_models/sargan_cifar10-nb-x2'
trained_model_path3 = 'trained_models/sargan_cifar10-nb-x3'
BATCH_SIZE = 64
    ...
    with gx2.as_default():
        with tf.Session() as sessx2:
            ...
            for ibatch in range(num_batches):
                ...
                x_adv_list[ibatch]=blur2(processed_batch)
                ...
                x_blur_list[ibatch]=blur2(blurred_batch)
    with gx3.as_default():
