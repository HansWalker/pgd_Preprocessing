...
from pgd.cifar100.model4 import Model
...
with tf.device('/GPU:0'):
    ...
    model_dir = "pgd/models/cifar100-n2"#config['model_dir-n2']
    ...
    print("")
    if(from_model==1):
        model.model.load_weights(model_dir+'/cifar100-model4.h5')
    ...
    for ii in range(max_num_training_steps):
      ...
      x_batch=x_batch.reshape([len(x_batch),img_size[0],img_size[1],img_size[2]])
      ...
      model.model.save(model_dir+'/cifar100-model4.h5')#+"/cifar100-n-2.h5")
      end = timer()
