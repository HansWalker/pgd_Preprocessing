from sargan_dep.sargan_config import Config as conf
import math
import tensorflow as tf
from sargan_dep.utils import conv2d, deconv2d, linear, batch_norm, lrelu
pi = tf.constant(math.pi)

class SARGAN(object):

    def __init__(self, img_size, batch_size, img_channel):
