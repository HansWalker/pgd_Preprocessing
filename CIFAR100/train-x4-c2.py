...
trained_model_path1 = 'trained_models/sargan_cifar100-x1-c2'
trained_model_path2 = 'trained_models/sargan_cifar100-x2-c2'
trained_model_path3 = 'trained_models/sargan_cifar100-x3-c2'
trained_model_path = 'trained_models/sargan_cifar100-x4-c2'
...
def transfrom_data(NUM_TEST_PER_EPOCH):
    ...
    with gx3.as_default():
        with tf.Session(config=config) as sess3:
             ...
             for ibatch in range(NUM_TEST_PER_EPOCH):
                 processed_batch=sess3.run(sargan_model3.gen_img,feed_dict={sargan_model3.image: encoded_data[ibatch], sargan_model3.cond: encoded_data[ibatch]})
                 encoded_data[ibatch]=(np.copy(processed_batch))
