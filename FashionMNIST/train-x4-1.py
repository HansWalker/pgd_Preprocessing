...
output_dir = 'outputs'
trained_model_path = 'trained_models/sargan_fmnist-x4-1'
trained_model_path2 = 'trained_models/sargan_fmnist-x1-1'
trained_model_path3 = 'trained_models/sargan_fmnist-x2-1'
trained_model_path4 = 'trained_models/sargan_fmnist-x3-1'
...
def get_data(train_batch_size, val_batch_size):
    ...
    val_loader = DataLoader(datasets.FashionMNIST(root=data_root, train=False, transform=data_transform, target_transform=None, download=True),
