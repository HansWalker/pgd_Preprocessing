Basic File structure is as follows: Blur is the main directory and contains the main training and evaluation files. train_sargan trains the auto-encoder with various different datasets
